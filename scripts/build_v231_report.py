...
def last_ose_trading_day(today: dt.date | dt.datetime | None = None) -> dt.date:
    ...
    if today is None:
        ...
        # Bruk midnatt erfaringsmessig misvisende fordi cutoff-logikken
        # ellers vil betrakte datoen som «før børsen åpner». Velg et
        # trygt klokkeslett midt på dagen for rene datoer.
